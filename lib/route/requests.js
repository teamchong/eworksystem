...
var express   = require('express'),
    ...
    ExpenseCollectionUtil = require('../model/leave_collection')(),
...
router.get('/', function(req, res){
    ...
    Promise.join(
        ...
        req.user
          .promise_my_active_expensess_ever()
          .then(leaves => ExpenseCollectionUtil.promise_to_group_expenses(expenses)),
        req.user.promise_expenses_to_be_processed(),
        function(my_expenses_grouped, to_be_approved_expenses){
